...
if st.session_state.user_id:
  try:
    ...
    # Cập nhật thời gian hoạt động gần nhất để Admin Dashboard nhận diện Online
    ...
    if user_data:
      ...
      # Đồng bộ số dư xu thời gian thực từ Database
...
# ================= HIỂN THỊ THÔNG BÁO TỪ ADMIN (BROADCAST) =================
try:
