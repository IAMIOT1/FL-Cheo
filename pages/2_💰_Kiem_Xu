...
st.markdown("Yêu cầu: Bạn phải thực hiện Tym/Comment/Follow thật trên link mục tiêu, sau đó tải ảnh chụp màn hình minh chứng (đối với bình luận) để hệ thống cộng xu.")
...
if not campaigns:
    ...
    for camp in campaigns:
        ...
        with st.container():
            ...
            # Form tải ảnh minh chứng chống gian lận
            with st.form(key=f"form_job_{camp['_id']}"):
                ...
                submitted_job = st.form_submit_button("Xác Nhận Đã Hoàn Thành & Nhận Xu")
                ...
                if submitted_job:
                    ...
                    if not check_acc:
                        ...
                        # Tắt chiến dịch hoặc ghi nhận hoàn thành
                        ...
                        history_col.insert_one({
                            ...
                            "coins": camp["reward"],
                            "time": os.path.exists("time") # Ghi nhận mốc thời gian cơ bản
                        })
