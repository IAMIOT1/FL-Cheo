...
# Các Tab phân loại nhiệm vụ Instagram
...
with tab_like:
    render_ig_jobs(["Thả tim (Tym)", "Thả tim", "Tym", "Like"])

with tab_follow:
    render_ig_jobs(["Theo dõi (Follow)", "Theo dõi", "Follow"])

with tab_comment:
    render_ig_jobs(["Bình luận (Comment)", "Bình luận", "Comment"])